        ...
        <div className="flex h-full">
          ...
          <div className="w-3/5 flex-none bg-gray-200 flex items-center px-8 mt-8 padingleft" data-aos="fade-right">
            <div className="p-8 transform hover:scale-105 mt-10">
              ...
              <form className="newsletter-form mttop">
  <div className="newsletter-overlay"></div>
  <div className="newsletter-content">
    <h2 className="font-bold text-xl text-purple-600">Get more updates...</h2>
    <p className="text-neutral-700">Sign up for our newsletter and you'll be the first to find out about new features</p>
  </div>
  <div className="flex gap-1">
    <div className="input-container">
      <input placeholder="Mail..." className="input-field" type="text" />
    </div>
